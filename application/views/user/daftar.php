...
<div class="container-fluid">
  ...
  <div class="form-row">
    <div class="col-md-6 mb-3">
      ...
      <div class="custom-file">
        <input type="file" class="custom-file-input" id="ijasah" name="ijasah" required>
        <label class="custom-file-label" for="image">Choose file</label>
      </div>
    </div>
    <div class="col-md-6 mb-3">
      ...
      <div class="custom-file">
        <input type="file" class="custom-file-input" id="skck" name="skck" required>
        <label class="custom-file-label" for="image">Choose file</label>
      </div>
    </div>
  </div>
  <div class="form-row">
    <div class="col-md-6 mb-3">
      ...
      <div class="custom-file">
        <input type="file" class="custom-file-input" id="surat_dokter" name="surat_dokter" required>
        <label class="custom-file-label" for="image">Choose file</label>
      </div>
    </div>
    <div class="col-md-6 mb-3">
      ...
      <div class="custom-file">
        <input type="file" class="custom-file-input" id="lisensi" name="lisensi" required>
        <label class="custom-file-label" for="image">Choose file</label>
      </div>
    </div>
  </div>
